...
A generic type variable `ErrorId` constrained by the generic type variable [`Id`](../3-generic-type-variables.md#errors-less-than-id-greater-than) of the [`Errors`](broken-reference) object indicates the type picked from the [`Id`](../3-generic-type-variables.md#errors-less-than-id-greater-than) and its exact type is useful in picking the specific error from the storage.
