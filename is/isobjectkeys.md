...
A generic type variable `Obj` indicates the type of the given [`value`](isobjectkeys.md#value-any) parameter by default [`object`](https://www.typescriptlang.org/docs/handbook/basic-types.html#object) via the [return type](isobjectkeys.md#return-type) `value is Obj`.
