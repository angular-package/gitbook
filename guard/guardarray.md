...
The `Payload` generic type variable constrained by [`object`](https://www.typescriptlang.org/docs/handbook/basic-types.html#object) indicates the type of the [`payload`](guardarray.md#payload-payload) parameter of the main function from which it gets its value and callback function [`payload`](../types/resultcallback.md#payload-payload) parameter.
